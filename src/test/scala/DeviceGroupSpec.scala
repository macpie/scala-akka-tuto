...
class DeviceGroupSpec extends FunSuite {
  ...
  test("ignore requests for wrong groupId") {
    val probe = TestProbe()
    val groupActor = system.actorOf(DeviceGroup.props("group"))
  ...
  test("be able to list active devices") {
    val probe = TestProbe()
    val groupActor = system.actorOf(DeviceGroup.props("group"))
  ...
  test("be able to list active devices after one shuts down") {
    val probe = TestProbe()
    val groupActor = system.actorOf(DeviceGroup.props("group"))
  ...
  test("be able to collect temperatures from all active devices") {
    val probe = TestProbe()
    val groupActor = system.actorOf(DeviceGroup.props("group"))
